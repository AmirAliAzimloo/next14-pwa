...
const BlogerBox = ({ data }) => {
   return (
      <div className=" flex justify-start items-center gap-2 h-[80px] w-full rounded-lg hover:bg-white transition-all duration-500 p-2">
         <Link  className=" min-w-[80px] w-[80px] h-[80px] relative" href={data.link}><Image src={data.img}  fill className=" object-cover rounded-full border-2 border-blue-500" alt={data.title} /></Link>
