...
const MidBannerDetails = ({ goalId }) => {
   ...
   const updater = (e) => {
      ...
      const url = `https://mernfa-fileshop-server.iran.liara.run/api/update-post/${goalId}`;
      axios
         .post(url, formData)
         .then((d) => {
   ...
   const remover = () => {
      const url = `https://mernfa-fileshop-server.iran.liara.run/api/delete-post/${goalId}`;
      axios
         .post(url)
         .then((d) => {
   ...
   useEffect(() => {
      axios
         .get(
            `https://mernfa-fileshop-server.iran.liara.run/api/get-post-by-id/${goalId}`
         )
         .then((d) => {
            setfullData(d.data);
            setTag(d.data.tags);
