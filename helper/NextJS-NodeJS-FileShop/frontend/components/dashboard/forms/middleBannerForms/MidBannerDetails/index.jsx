...
const MidBannerDetails = ({ midBanId }) => {
   ...
   const updater = (e) => {
      ...
      const url = `https://mernfa-fileshop-server.iran.liara.run/api/update-middle-banner/${midBanId}`;
      axios
         .post(url, formData)
         .then((d) => {
   ...
   useEffect(() => {
      axios
         .get(
            `https://mernfa-fileshop-server.iran.liara.run/api/get-mid-ban/${midBanId}`
         )
         .then((d) => {
            setfullData(d.data);
         })
   ...
   const remover = () => {
      const url = `https://mernfa-fileshop-server.iran.liara.run/api/delete-middle-banner/${midBanId}`;
      axios
         .post(url)
         .then((d) => {
